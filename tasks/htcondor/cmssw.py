...
# ):
#     """
#     This is no longer maintained. The BundleCMSSWTask is now implemented in the singularity_sandbox module.
#     Running this preparation taskin a singularity container holds several advantages, e.g. we dont have to wait for ressources.
#     """
